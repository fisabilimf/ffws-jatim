const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["js/common-components-KO07M7D3.js","js/react-vendor-CILUtiK9.js","js/mapbox-vendor-C_nsdMnr.js","css/mapbox-vendor-BVO_c2QR.css","js/vendor-HC16imTC.js","js/services-BHoYLIlq.js","js/device-components-CA_EA_AT.js","js/charts-vendor-Tn6b3eh3.js"])))=>i.map(i=>d[i]);
import { r as reactExports, j as jsxRuntimeExports } from './react-vendor-CILUtiK9.js';
import { S as SidebarTemplate } from './layout-components-CqzudODP.js';
...
const MonitoringChart = reactExports.lazy(() => __vitePreload(() => import('./common-components-KO07M7D3.js').then(n => n.M),true              ?__vite__mapDeps([0,1,2,3,4,5,6,7]):void 0));
const TanggulAktual = reactExports.lazy(() => __vitePreload(() => import('./common-components-KO07M7D3.js').then(n => n.T),true              ?__vite__mapDeps([0,1,2,3,4,5,6,7]):void 0));
const PredictionChart = reactExports.lazy(() => __vitePreload(() => import('./common-components-KO07M7D3.js').then(n => n.c),true              ?__vite__mapDeps([0,1,2,3,4,5,6,7]):void 0));
const DETAIL_TABS = [
