...
const GoogleMapsSearchbar = lazy(() => import('../components/ui/GoogleMapsSearchbar'))
const MapboxMap = lazy(() => import('../components/devices/MapboxMap'))
const FloatingLegend = lazy(() => import('../components/ui/FloatingLegend'))
...
const AutoSwitchToggle = lazy(() => import('../components/ui/AutoSwitchToggle'))
...
const Layout = ({ children }) => {
  ...
  const handleStationChange = useCallback((station, index) => {
    setCurrentStationIndex(index)
  ...
  return (
    <div className="h-screen bg-gray-50 relative overflow-hidden">
      ...
      <div className="w-full h-full relative z-0">
        <Suspense fallback={<div className="w-full h-full bg-gray-200 animate-pulse flex items-center justify-center">Loading Map...</div>}>
          <MapboxMap 
            ref={mapRef}
      ...
      <Suspense fallback={<div className="fixed inset-0 bg-black/50 flex items-center justify-center"><div className="bg-white rounded-lg p-8 animate-pulse">Loading...</div></div>}>
        <StationDetail 
