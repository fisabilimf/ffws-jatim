          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="flex items-center justify-end gap-2 mb-1">
                ...
                <div className={`text-sm font-semibold px-3 py-1 rounded-lg border shadow-sm ${
                  stationData.status === 'safe' ? 'bg-gradient-to-r from-green-100 to-green-200 text-green-800' :
                  stationData.status === 'warning' ? 'bg-gradient-to-r from-yellow-100 to-yellow-200 text-yellow-800' :
                  stationData.status === 'alert' ? 'bg-gradient-to-r from-red-100 to-red-200 text-red-800' :
