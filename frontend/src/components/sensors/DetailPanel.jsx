    ...
    return (
        ...
        >
            <div className="h-full flex flex-col">
                {/* Header Panel - Modern Card Design */}
                <div className="bg-white border-b-2 border-blue-100 p-6 flex-shrink-0 shadow-xl relative overflow-hidden">
                    {/* Background Pattern */}
                            ...
                            <div className="flex items-center justify-center space-x-8 text-base">
                                {DETAIL_TABS.map((tab) => (
                                    <button
                                        ...
                                        className={`relative py-4 px-7 transition-all duration-500 ease-out rounded-xl shadow-lg group border-2 ${
                                            activeTab === tab.key
                                                ? "text-blue-800 font-bold bg-gradient-to-r from-blue-50 to-indigo-50 shadow-xl border-blue-200"
                                                : "text-gray-600 font-semibold hover:text-blue-700 hover:bg-blue-50/50 border-transparent hover:border-blue-100"
                                    ...
                                    >
                                        ...
                                        {activeTab === tab.key ? (
                                            <div className={`absolute -bottom-1 left-1/2 w-14 h-1 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full shadow-sm ${
                                                isDotAnimating && previousTab === tab.key 
                                                    ? 'underline-close' 
                                                    : 'underline-active'
                                            }`} />
                                        ) : (
