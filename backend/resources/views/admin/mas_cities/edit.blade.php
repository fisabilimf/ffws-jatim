...
@section('page-description', 'Mengubah data kota')
@section('breadcrumb', 'Cities')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('admin.mas-cities.update', $masCity) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="cities_code" 
                           name="cities_code" 
                           value="{{ old('cities_code', $masCity->cities_code) }}"
                ...
                <div>
                    ...
                    <input type="text" 
                           id="cities_name" 
                           name="cities_name" 
                           value="{{ old('cities_name', $masCity->cities_name) }}"
