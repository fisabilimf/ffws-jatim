...
@section('title', 'Edit UPTD')

@section('header')
    <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Edit UPTD</h1>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Edit UPTD Information</h2>
            </div>
            
            <form action="{{ route('admin.mas-uptds.update', $masUptd) }}" method="POST" class="p-6 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <select id="upt_code" 
                        ...
                        @foreach($upts as $upt)
                            <option value="{{ $upt->upts_code }}" 
                                    {{ old('upt_code', $masUptd->upt_code) == $upt->upts_code ? 'selected' : '' }}>
