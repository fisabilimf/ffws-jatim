...
@section('title', 'Edit Device Parameter')

@section('header')
    <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Edit Device Parameter</h1>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Device Parameter Information</h2>
            </div>
            
            <form action="{{ route('admin.mas-device-parameters.update', $masDeviceParameter) }}" method="POST" class="p-6 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" 
                           id="code" 
                           name="code" 
                           value="{{ old('code', $masDeviceParameter->code) }}"
                ...
                <div>
                    ...
                    <input type="text" 
                           id="name" 
                           name="name" 
                           value="{{ old('name', $masDeviceParameter->name) }}"
