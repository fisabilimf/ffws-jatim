...
@section('title', 'Create New Device Parameter')

@section('header')
    <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Create New Device Parameter</h1>
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
            ...
            <form action="{{ route('admin.mas-device-parameters.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           placeholder="e.g., TEMP, HUMID, PRES"
                           required>
                    @error('code')
