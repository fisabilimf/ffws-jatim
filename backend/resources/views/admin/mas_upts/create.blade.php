...
@section('title', 'Create New UPT')

@section('header')
    <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Create New UPT</h1>
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
            ...
            <form action="{{ route('admin.mas-upts.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <select id="cities_code" 
                        ...
                        @foreach($cities as $city)
                            <option value="{{ $city->cities_code }}" {{ old('cities_code') == $city->cities_code ? 'selected' : '' }}>
                                {{ $city->cities_name }}
                            </option>
                        @endforeach
                    </select>
