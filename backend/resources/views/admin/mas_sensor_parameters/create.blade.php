...
@section('title', 'Create New Sensor Parameter')

@section('header')
    <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Create New Sensor Parameter</h1>
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
            ...
            <form action="{{ route('admin.mas-sensor-parameters.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           placeholder="e.g., WATER_LEVEL, FLOW_RATE, PH"
                           required>
                    @error('code')
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           placeholder="e.g., Water Level, Flow Rate, pH Level"
                           required>
                    @error('name')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
