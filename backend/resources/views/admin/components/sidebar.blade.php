<!-- Sidebar -->
<aside class="bg-white min-h-screen flex-shrink-0 transition-all duration-300 ease-in-out fixed lg:relative z-30 border-r border-gray-200" 
       :class="{ 
    ...
    <div class="flex items-center justify-between h-16 px-6 border-b border-gray-200">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center group sidebar-logo">
            ...
            <span class="ml-3 text-xl font-semibold text-gray-900 transition-all duration-300"
    ...
    <!-- Navigation Menu -->
    <nav class="mt-6 transition-all duration-300"
         :class="{ 'px-3': $store.sidebar.open || window.innerWidth < 1024, 'px-2': !$store.sidebar.open && window.innerWidth >= 1024 }">
        <div class="space-y-1">
            <!-- Dashboard -->
            <a href="{{ route('admin.dashboard') }}" 
               class="sidebar-nav-item group flex items-center text-sm font-medium rounded-md relative transition-all duration-300
        ...
        <div class="mt-6 pt-6 border-t border-gray-200">
            <div class="space-y-1">
                <!-- Master Heading -->
                <div class="px-3 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider transition-all duration-300"
