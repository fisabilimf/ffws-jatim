...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Add New Predicted Calculated Discharge</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.predicted-calculated-discharges.store') }}">
                @csrf
                ...
                <div class="form-group">
                    <div class="card bg-light">
                        <div class="card-body">
                            ...
                            <ul class="mb-0 small">
                                <li>Predicted value represents the forecasted sensor reading</li>
                                <li>Predicted discharge is calculated using the selected rating curve formula</li>
                                <li>All values must be non-negative numbers</li>
                                <li>Calculated At should reflect when the prediction was made</li>
                                <li>This data is typically generated by ML models or forecasting algorithms</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Create Predicted Discharge
                    </button>
                    <a href="{{ route('admin.predicted-calculated-discharges.index') }}" class="btn btn-secondary">
