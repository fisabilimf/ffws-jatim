...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Add New WhatsApp Number</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.mas-whatsapp-numbers.store') }}">
                @csrf
                ...
                <div class="form-group mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Create WhatsApp Number
                    </button>
                    <a href="{{ route('admin.mas-whatsapp-numbers.index') }}" class="btn btn-secondary">
