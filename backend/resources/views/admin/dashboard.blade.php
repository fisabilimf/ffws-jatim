...
<div class="space-y-6">
    <!-- Welcome Message -->
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 overflow-hidden shadow-lg sm:rounded-lg">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="card-dark overflow-hidden shadow-sm sm:rounded-lg transition-colors duration-300">
            <div class="p-6">
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $stats['pending_users'] ?? 0 }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="card-dark overflow-hidden shadow-sm sm:rounded-lg transition-colors duration-300">
            <div class="p-6">
                ...
                <div class="space-y-3">
                    <a href="{{ route('admin.users.index') }}" class="quick-action-item flex items-center p-3 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg transition-colors duration-200">
                        <i class="fas fa-users text-gray-400 dark:text-gray-500 mr-3"></i>
                        Kelola Users
                    </a>
                    <a href="{{ route('admin.settings.index') }}" class="quick-action-item flex items-center p-3 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg transition-colors duration-200">
                        <i class="fas fa-cog text-gray-400 dark:text-gray-500 mr-3"></i>
                        Pengaturan Sistem
                    </a>
                    <a href="{{ route('admin.profile.index') }}" class="quick-action-item flex items-center p-3 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg transition-colors duration-200">
                        <i class="fas fa-user text-gray-400 dark:text-gray-500 mr-3"></i>
                        Profil Saya
                    </a>
                </div>
            </div>
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="flex-shrink-0">
                                <div class="h-8 w-8 rounded-full bg-gray-300 dark:bg-gray-600 flex items-center justify-center">
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-200">{{ substr($user->name, 0, 1) }}</span>
                                </div>
                            </div>
