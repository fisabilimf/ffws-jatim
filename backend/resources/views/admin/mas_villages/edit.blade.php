...
@section('page-description', 'Mengubah data desa')
@section('breadcrumb', 'Villages')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('admin.mas-villages.update', $masVillage) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="villages_code" 
                           name="villages_code" 
                           value="{{ old('villages_code', $masVillage->villages_code) }}"
                ...
                <div>
                    ...
                    <input type="text" 
                           id="villages_name" 
                           name="villages_name" 
                           value="{{ old('villages_name', $masVillage->villages_name) }}"
