                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="mas_sensor_id" id="mas_sensor_id" required
                            ...
                            <option value="{{ $sensor->id }}" {{ old('mas_sensor_id') == $sensor->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select name="mas_model_id" id="mas_model_id" required
                            ...
                            @foreach($models as $model)
                                <option value="{{ $model->id }}" {{ old('mas_model_id') == $model->id ? 'selected' : '' }}>
                                    {{ $model->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="threshold_prediction_status" id="threshold_prediction_status"
                            ...
                            <option value="safe" {{ old('threshold_prediction_status') == 'safe' ? 'selected' : '' }}>Aman</option>
                            <option value="warning" {{ old('threshold_prediction_status') == 'warning' ? 'selected' : '' }}>Peringatan</option>
                            <option value="danger" {{ old('threshold_prediction_status') == 'danger' ? 'selected' : '' }}>Bahaya</option>
                        </select>
