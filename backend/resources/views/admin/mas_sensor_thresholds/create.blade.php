...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Add New Sensor Threshold</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.mas-sensor-thresholds.store') }}">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('sensor_thresholds_code') }}" 
                                   required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('sensor_thresholds_name') }}" 
                                   required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('sensor_thresholds_value_1') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="color" 
                                   ...
                                   value="{{ old('sensor_thresholds_value_1_color', '#28a745') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('sensor_thresholds_value_2') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="color" 
                                   ...
                                   value="{{ old('sensor_thresholds_value_2_color', '#ffc107') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('sensor_thresholds_value_3') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="color" 
                                   ...
                                   value="{{ old('sensor_thresholds_value_3_color', '#fd7e14') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('sensor_thresholds_value_4') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="color" 
                                   ...
                                   value="{{ old('sensor_thresholds_value_4_color', '#dc3545') }}">
                ...
                <div class="form-group mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Create Threshold
                    </button>
                    <a href="{{ route('admin.mas-sensor-thresholds.index') }}" class="btn btn-secondary">
