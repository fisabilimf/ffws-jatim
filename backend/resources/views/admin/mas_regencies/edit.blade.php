...
@section('page-description', 'Mengubah data kabupaten')
@section('breadcrumb', 'Regencies')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('admin.mas-regencies.update', $masRegency) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="regencies_code" 
                           name="regencies_code" 
                           value="{{ old('regencies_code', $masRegency->regencies_code) }}"
                ...
                <div>
                    ...
                    <input type="text" 
                           id="regencies_name" 
                           name="regencies_name" 
                           value="{{ old('regencies_name', $masRegency->regencies_name) }}"
