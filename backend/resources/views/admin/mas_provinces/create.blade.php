...
@section('page-description', 'Menambahkan data provinsi baru')
@section('breadcrumb', 'Provinces')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('admin.mas-provinces.store') }}" method="POST" class="space-y-6">
            @csrf
